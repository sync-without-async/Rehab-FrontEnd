...
import TheraCheckDetail from './TheraCheckDetail';
...
const TheraSeveralReserve = () => {
  ...
  return (
    <>
      ...
      {showDetailModal && <TheraCheckDetail onClose={handleCloseModal} />}
    </>
  );
};

export default TheraSeveralReserve;
